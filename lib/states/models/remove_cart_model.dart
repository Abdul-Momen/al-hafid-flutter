...
class RemoveCartModel {
  RemoveCartModel({
    required this.cartLinesRemove,
  });

  CartLinesRemove cartLinesRemove;

  factory RemoveCartModel.fromRawJson(String str) => RemoveCartModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory RemoveCartModel.fromJson(Map<String, dynamic> json) => RemoveCartModel(
    cartLinesRemove: CartLinesRemove.fromJson(json["cartLinesRemove"]),
  );

  Map<String, dynamic> toJson() => {
    "cartLinesRemove": cartLinesRemove.toJson(),
  };
}

class CartLinesRemove {
  CartLinesRemove({
    required this.cart,
  ...
  factory CartLinesRemove.fromRawJson(String str) => CartLinesRemove.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory CartLinesRemove.fromJson(Map<String, dynamic> json) => CartLinesRemove(
