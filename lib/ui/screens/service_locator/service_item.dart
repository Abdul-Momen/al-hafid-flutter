            ...
            children: [
              ...
              _buildTitle(
                  title: Preference.getIsArabicFlag()
                      ? ConstantStrings.storeloactorlist[0]
                              [storeLocatorModel.name] ??
                          storeLocatorModel.name
                      : storeLocatorModel.name,
                  fSize: 18.sp),
              addH(10.h),
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: _buildTitle(
                        title:Preference.getIsArabicFlag()
                            ?ConstantStrings.storeloactorlist[0][storeLocatorModel.address]?? storeLocatorModel.address:storeLocatorModel.address,
                        fSize: 12.sp,
