...
class StoreLocatorScreen extends StatefulWidget {
  static String routeName = '/storelocator';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            // Title
            CustomTitle(
              title: AppLocalizations.of(context)!.store_Locator,
            ),
            ...
            Obx(() {
              if (_productsCon.storeLocatorLoading.value) {
                ...
                if (_productsCon.storeLocatorList.isEmpty) {
                  return Padding(
                    padding: EdgeInsets.only(top: 100.h),
                    child: Center(
                      child: Text(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemCount: _productsCon.storeLocatorList.length,
                          scrollDirection: Axis.vertical,
                          itemBuilder: (BuildContext context, int index) {
                            return StoreItem(
                              storeLocatorModel:
                                  _productsCon.storeLocatorList[index],
                            );
                          },
                        ),
                        addH(10.h),
