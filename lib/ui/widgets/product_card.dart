...
class _ProductCardState extends State<ProductCard> {
  ...
  Widget build(BuildContext context) {
    ...
    print("p "+widget.pModel.tags.toString());
    print("p c "+_productsCon.promoCodes.toString());
    print("p i "+_productsCon.promoImages.length.toString());
    //for dynamic promo codes
    for (var i = 0; i < _productsCon.promoCodes.length; i++) {
        print("test");
      if (widget.pModel.tags.contains(_productsCon.promoCodes[i].trim())) {
        print("code");
        print(_productsCon.promoCodes[i].toString());
        print(i.toString());
        selectedPromoImageIndex = i;
      }
    }

    print("p in "+selectedPromoImageIndex.toString());
          ...
          child: Center(
            child: Stack(
              children: [
                ...
                InkWell(
                  ...
                  onTap: () {
                    Get.toNamed(ProductDetails.routeName,
                        arguments: [widget.pModel.id,widget.pModel.handle]);
                  },
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        CustomImg(
                          imgUrl:widget.pModel.imagesInfo.isNotEmpty? widget.pModel.imagesInfo[0].src:'',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            if (selectedPromoImageIndex != 0)
                              CustomImg(
                                imgUrl: _productsCon
                                    .promoImages[selectedPromoImageIndex].trim(),
                                imgWidth: 30.w,
                                imgHeight: 20.h,
                                imgFit: BoxFit.fill,
                              ),
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: BuildText(
                                text: widget.pModel.variants[0].sku,
                                txtClr: Colors.black45,
                                maximumLines: 1,
                                fontSize:
                                    Preference.getIsArabicFlag() ? 7.sp : 9.sp,
                              ),
                            ),
                          ],
                        ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              BuildText(
                                text:
                                    // '${AppLocalizations.of(context)!.iqd}${value.format(int.parse(double.parse(widget.pModel.variants[0].price).toStringAsFixed(0)) * widget.exchangeRate)}',
                                    '${AppLocalizations.of(context)!.iqd} ${value.format(calculateRoundPrice(inputNum: double.parse(widget.pModel.variants[0].price) * widget.exchangeRate))}',
                                txtClr: Colors.black,
                                maximumLines: 1,
                                fontSize: 8.sp,
                              ),
                        ...
                        if (widget
                                .pModel.variants[0].compareAtPrice.isNotEmpty &&
                            widget.pModel.variants[0].compareAtPrice != null)
                          Padding(
                            padding:
                            ...
                            child: Row(
                              ...
                              children: [
                                /*BuildText(
                                  text:
                                      '\$${widget.pModel.variants[0].compareAtPrice}',
                                  txtClr: Colors.black45,
                                  maximumLines: 1,
                                  fontSize: 9.sp,
                                ...
                                BuildText(
                                  text:
                                      '${AppLocalizations.of(context)!.iqd}${value.format(double.parse(widget.pModel.variants[0].compareAtPrice) * widget.exchangeRate)}',
                                  //'${AppLocalizations.of(context)!.iqd}${myRoundedNumber}',
                                  txtClr: Colors.black45,
                                  maximumLines: 1,
                                  fontSize: 8.sp,
                                  textDecoration: TextDecoration.lineThrough,
                        ...
                        addH(2.h),
                        if (widget.pModel.variants[0].inventoryQuantity == 0)
                          Center(
                            child: Container(
                              decoration: BoxDecoration(
                    ...
                    child: InkWell(
                      onTap: () => {
                        ...
                        wishlistModel = WishlistModel(
                          ...
                          status: '',
                          image: widget.pModel.imagesInfo[0].src,
                          price:
                              '${value.format(calculateRoundPrice(inputNum: double.parse(widget.pModel.variants[0].price) * widget.exchangeRate))}',
                          stock: '',
                          isFavorite: true,
                          adminGraphQlapiId:
                              "gid://shopify/ProductVariant/${widget.pModel.variants[0].id}",
                          quantity: 1,
                        ),
                ...
                //for off image
                if (widget.pModel.variants[0].compareAtPrice.isNotEmpty &&
                    widget.pModel.variants[0].compareAtPrice != null)
                  Positioned(
                    top: 15.h,
                    left: 10.w,
                    child: InkWell(
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          Center(
                              child: Text(
                            '${AppLocalizations.of(context)!.off}\n${((double.parse(widget.pModel.variants[0].compareAtPrice) - double.parse(
                                  widget.pModel.variants[0].price,
                                )) / double.parse(widget.pModel.variants[0].compareAtPrice) * 100).toStringAsFixed(0)}%',
                            style: TextStyle(
                              fontSize: 8.sp,
